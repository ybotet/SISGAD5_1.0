Perfecto. A continuación te presento el archivo **`AGENT.md`** diseñado específicamente para que un agente de IA (como yo, u otro asistente de código) pueda trabajar de forma sistemática, autónoma y alineada con tus objetivos en el proyecto SISGAD5.

Este archivo está pensado para ser colocado en la raíz del repositorio (`SISGAD5_1.0/AGENT.md`) y servirá como **manual de operaciones** para cualquier agente de IA que colabore en el proyecto.
