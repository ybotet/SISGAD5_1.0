...
const claveBaseSchema = z.object({
  clave: z
    .string()
    .max(8, "ERROR.CLAVE.CLAVE.MAX_LENGTH")
    .optional()
    .nullable(),
  descripcion: z
    .string()
    .max(25, "ERROR.CLAVE.DESCRIPCION.MAX_LENGTH")
    .optional()
    .nullable(),
  valor_p: z
    .number()
    .min(0, "ERROR.CLAVE.VALOR_P.MIN_VALUE")
    .optional()
    .nullable(),
...
const listClaveSchema = z.object({
  ...
  sortBy: z
    .enum(["clave", "descripcion", "createdAt", "updatedAt"])
    .default("createdAt"),
