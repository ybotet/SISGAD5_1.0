  ...
  const menuItems: MenuItem[] = [
    { id: "", name: t("menu.inicio"), icon: "ri-dashboard-line" }, // solo autenticado
    {
      ...
      children: [
        {
          id: "telefonos",
          name: t("menu.telefonos"),
          icon: "ri-phone-line",
          permission: "telefonos.ver",
        },
        {
          id: "lineas",
          name: t("menu.lineas"),
          icon: "ri-git-branch-line",
          permission: "lineas.ver",
        },
        {
          id: "pizarras",
          name: t("menu.pizarras"),
          icon: "ri-dashboard-line",
          permission: "pizarras.ver",
        },
        {
          id: "quejas",
          name: t("menu.quejas"),
          icon: "ri-error-warning-line",
          permission: "quejas.ver",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      children: [
        ...
        {
          id: "clasificacion",
          name: t("menu.clasificacion"),
          icon: "ri-price-tag-3-line",
          permission: "nomencladores.gestionar",
        },
        {
          id: "clasificadorclave",
          name: t("menu.clasificador_clave"),
          icon: "ri-key-line",
          permission: "nomencladores.gestionar",
        },
        {
          id: "clasifpizarra",
          name: t("menu.clasif_pizarra"),
        ...
        {
          id: "propietarios",
          name: t("menu.propietarios"),
          icon: "ri-user-line",
          permission: "nomencladores.gestionar",
        },
        {
          id: "resultadoprueba",
          name: t("menu.resultado_prueba"),
          icon: "ri-test-tube-line",
          permission: "nomencladores.gestionar",
        },
        {
          id: "senalizaciones",
          name: t("menu.senalizaciones"),
        ...
        {
          id: "tipolinea",
          name: t("menu.tipo_linea"),
          icon: "ri-git-branch-line",
          permission: "nomencladores.gestionar",
        },
        {
          id: "tipomovimientos",
          name: t("menu.tipo_movimiento"),
          icon: "ri-arrow-left-right-line",
          permission: "nomencladores.gestionar",
        },
        {
          id: "tipopizarra",
          name: t("menu.tipo_pizarra"),
          icon: "ri-layout-grid-line",
          permission: "nomencladores.gestionar",
        },
        {
          id: "tipoqueja",
          name: t("menu.tipo_queja"),
    ...
    {
      id: "operarios",
      name: t("menu.operarios"),
      icon: "ri-team-line",
      permission: "trabajadores.gestionar",
    },
    {
      id: "stats",
      name: t("menu.estadisticas"),
      icon: "ri-bar-chart-line",
      permission: "estadisticas.ver",
    },
    {
      id: "admin",
      name: t("menu.panel_admin"),
      icon: "ri-admin-line",
      children: [
        {
          id: "usuarios",
          name: t("menu.gestion_usuarios"),
          ...
          <div key={item.id} className="mb-1">
            ...
            >
              ...
              {!isCollapsed && item.children && (
                <i
                  className={`ri-arrow-${expandedItems.includes(item.id) ? "down" : "right"}-s-line text-sm`}
                ></i>
              )}
            </button>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div
                  ...
                  onClick={() => handleNavigation(`/sistema/profile`)}
                >
                  {usuario?.nombre
                ...
                <div className="text-xs text-blue-200">
                  {(usuario as any)?.tb_rol
                    ? ((usuario as any).tb_rol[0]?.nombre ?? "")
                    : ((usuario as any)?.Rols?.[0]?.nombre ?? "")}
                </div>
              </div>
            </div>
            <button
