...
export default function QuejaFilters({
  searchTerm,
  onSearchChange,
  estadoFilter,
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="flex-1">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Buscar por número de reporte (Escriba el numero completo)..."
              value={searchTerm}
        ...
        <div className="flex gap-2">
          <div className="relative">
            ...
            >
              ...
              <option value="Probada">Probada</option>
