import type { MandoItem } from '../../services/mandosService';

interface MandosModalProps {
    show: boolean;
    editingItem: MandoItem | null;
    saving: boolean;
    onClose: () => void;
    onSave: (formData: FormData) => void;
}

export default function MandosModal({
    show,
    editingItem,
    saving,
    onClose,
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
                <h3 className="text-lg font-semibold mb-4">
                    {editingItem ? 'Editar Mando' : 'Nuevo Mando'}
                </h3>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                type="text"
                                name="mando"
                                defaultValue={editingItem?.mando || ''}
                                required
                                maxLength={18}
                                disabled={saving}
