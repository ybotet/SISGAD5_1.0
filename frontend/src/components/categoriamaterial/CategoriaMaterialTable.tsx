...
interface CategoriaMaterialTableProps {
  items: CategoriaMaterialItem[];
  onEdit: (item: CategoriaMaterialItem) => void;
  onDelete: (id: number) => void;
  loading?: boolean;
}

export default function CategoriaMaterialTable({
  items,
  onEdit,
  onDelete,
  loading = false,
}: CategoriaMaterialTableProps) {
  if (loading) {
    return (
