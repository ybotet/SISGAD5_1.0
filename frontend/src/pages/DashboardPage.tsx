...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        setLoading(true);
        const [telRes, linRes, pizRes, quejaRes, traRes, clasRes] =
          await Promise.all([
        ...
        setRecent(
          (quejaRes?.data || []).slice(0, 5).map((q: any) => ({
  ...
  const stats = [
    {
      title: t("menu.telefonos"),
      value: counts.telefonos,
      color: "bg-blue-700",
      path: "/sistema/main/telefonos",
    },
    {
      title: t("menu.lineas"),
      value: counts.lineas,
      color: "bg-indigo-700",
      path: "/sistema/main/lineas",
    },
    {
      title: t("menu.pizarras"),
      value: counts.pizarras,
      color: "bg-sky-700",
      path: "/sistema/main/pizarras",
    },
    {
      title: t("menu.quejas"),
      value: counts.quejas,
      color: "bg-red-600",
      path: "/sistema/main/quejas",
    },
    {
      title: t("menu.operarios"),
      value: counts.operarios,
      color: "bg-emerald-600",
      path: "/sistema/operarios",
    },
    {
      title: t("menu.nomencladores"),
      value: counts.nomencladores,
      color: "bg-violet-600",
      path: "/sistema/main/nomencladores",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {recent.map((r, idx) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <button
                        onClick={() => navigate("/sistema/main/quejas")}
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-sm text-gray-600">
              gráficos rápidos, estadísticas o enlaces a reportes detallados.
            </p>
            <div className="mt-4">
              <button
                onClick={() => navigate("/sistema/stats")}
