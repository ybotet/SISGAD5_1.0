...
| Pendiente  | Alta      | 1–4 horas | TASK-000-04 | Crear CHANGELOG.md                                  | Documentación | Agente      |              | Formato Keep a Changelog + SemVer                       | `CHANGELOG.md`              |
| Pendiente  | Alta      | 1–4 horas | TASK-000-05 | Crear CONTRIBUTING.md con convenciones              | Documentación | Agente      |              | Convenciones de ramas, commits, PRs                     | `CONTRIBUTING.md`           |
...
| Alta       | Crítica (bloqueante) | 1–3 días  | TASK-100-03 | Diagrama de paquetes (5 paquetes)              | Modelado | Humano      |              | Diagrama UML con reglas de dependencia           | `docs/03-07`, `diagrams/`     |
| Alta       | Crítica (bloqueante) | 1–3 días  | TASK-100-04 | Diagramas de secuencia (3 escenarios críticos) | Modelado | Humano      |              | Diagramas UML con tablas de mensajes             | `docs/08`, `diagrams/`        |
| Alta       | Crítica (bloqueante) | 1–4 horas | TASK-100-05 | Diccionario de términos (Ubiquitous Language)  | Modelado | Humano      |              | Términos del dominio unificados                  | `docs/04 Словарь терминов.md` |
| Alta       | Crítica (bloqueante) | 1–4 horas | TASK-100-06 | Matriz de trazabilidad                         | Modelado | Humano      |              | Requisitos → Casos de uso → Clases               | `docs/`                       |
| Alta       | Crítica (bloqueante) | 1–4 horas | TASK-100-07 | User Story Map                                 | Modelado | Humano      |              | Mapa de historias de usuario por actor           | `docs/02 Акторы.md`           |
| Alta       | Crítica (bloqueante) | 1–4 horas | TASK-100-08 | Event Storming                                 | Modelado | Humano      |              | Eventos, comandos y agregados identificados      | `docs/04 Словарь терминов.md` |
...
| Completada | Crítica (bloqueante) | 1–4 horas | TASK-110-03 | Diseñar contratos OpenAPI 3.0 para Materials Service | Diseño | Humano      |              | Swagger implementado en Go                                  | `backend-materiales-go/docs/` |
| Pendiente  | Alta                 | 1–4 horas | TASK-110-04 | Modelo ER consolidado de las 3 BD                    | Diseño | Agente      |              | Diagrama Mermaid ER de `bd_users`, `bd_mp`, `bd_materiales` | `docs/er-diagram.md`          |
| Pendiente  | Alta                 | 1–4 horas | TASK-110-05 | Diseñar estrategia de autenticación (JWT + Refresh)  | Diseño | Agente      |              | Documento con flujo detallado                               | `docs/auth-strategy.md`       |
| Pendiente  | Alta                 | 1–4 horas | TASK-110-06 | Mapear permisos RBAC por endpoint                    | Diseño | Agente      |              | Matriz rol × endpoint                                       | `docs/rbac-matrix.md`         |
...
| Completada | Crítica (bloqueante) | 1–4 horas | TASK-550-04 | Documentación Swagger (RF-MAT-10)                  | Materials | Humano      |              | Swagger UI funcional   | `backend-materiales-go/docs/` |
...
| FASE 2    | 19              | 7           | 12         | 0           | 0          | 36.8%                 |
| FASE 3    | 12              | 2           | 10         | 0           | 0          | 16.7%                 |
| FASE 4    | 43              | 11          | 32         | 0           | 0          | 25.6%                 |
| FASE 5    | 62              | 13          | 49         | 0           | 0          | 21.0%                 |
| FASE 6    | 10              | 3           | 7          | 0           | 0          | 30.0%                 |
| FASE 7    | 89              | 1           | 88         | 0           | 0          | 1.1%                  |
| FASE 8    | 12              | 1           | 11         | 0           | 0          | 8.3%                  |
| FASE 9    | 9               | 0           | 9          | 0           | 0          | 0.0%                  |
| FASE 10   | 8               | 0           | 8          | 0           | 0          | 0.0%                  |
| FASE 11   | 3               | 0           | 3          | 0           | 0          | 0.0%                  |
| FASE 12   | 5               | 0           | 5          | 0           | 0          | 0.0%                  |
| **TOTAL** | **190**         | **48**      | **142**    | **0**       | **0**      | **25.3%**             |
